...
1. Create a directory `.phan/stubs` ([like Phan's](https://github.com/phan/phan/tree/v6/.phan/stubs)).
...
Phan is bundled with some internal stubs, but *only for extensions it uses for self-analysis*. See [.phan/internal_stubs/](https://github.com/phan/phan/tree/v6/.phan/internal_stubs)

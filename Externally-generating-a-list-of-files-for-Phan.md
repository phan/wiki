...
One way to generate this file list would be to create a file `.phan/bin/mkfilelist` (like [Phan's](https://github.com/phan/phan/blob/v6/.phan/bin/mkfilelist)) with the following contents.
...
You can then run `./.phan/bin/mkfilelist > files`. Take a look at [Phan's file list generator](https://github.com/phan/phan/blob/v6/.phan/bin/mkfilelist) to see an example.
